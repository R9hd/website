...
const WORDS = ["Computer Information Systems Graduate", "Tech Enthusiast"];
const TECH_STACK = ["Dart", "Java", "HTML", "SQL"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/R9hd" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/raghad-alshihry-7583532a3" },
  { icon: Mail, link: "mailto:raghadalshihry@gmail.com" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Building the unseen architecture of tomorrow’s intelligence.
                </p>
