...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/raghad-alshihry-7583532a3",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "+966 565 093 109",
    icon: WhatsApp,
    url: "https://wa.me/966565093109",
    color: "#128c7e",
    gradient: "from-[#ece5dd] via-[#dcf8c6] to-[#25d366]"
  },
  {
    name: "Telegram",
    ...
    subText: "@ra9had919",
    icon: Telegram,
    url: "https://t.me/ra9had919",
    color: "#24a1de",
    gradient: "from-[#8c8c8c] to-[#0088cc]"
  },
  {
    name: "GitHub",
    displayName: "Github",
  ...
  },
  {
    name: "Email",
    displayName: "Email",
    subText: "raghadalshihry@gmail.com",
    icon: Email,
//     ({ className, ...props }) => (
...
// </svg>
//     ),
    url: "mailto:raghadalshihry@gmail.com",
    color: "#ff8282",
